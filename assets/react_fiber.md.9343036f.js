...
<span class="line"><span style="color:#BABED8;">    tag</span><span style="color:#89DDFF;">,</span><span style="color:#BABED8;"> </span><span style="color:#676E95;font-style:italic;">// 标识我是什么类型的 Fiber 0 FunctionComponent、1 ClassComponent、3根节点（HostRoot）、4 HostPortal、 5宿主组件（Host Component），例如一个 DOM 元素（如 &lt;div&gt;、&lt;span&gt; 等）, 6 HostText</span></span>
